...
export default function DisposalRegister() {
  ...
  // Fetch disposal register data using PHP endpoint
  ...
  // Define columns matching PHP disposal register table exactly
