    ...
    <Page title="View DIN Form">
      ...
      <div className="din-print-page p-4 sm:p-5 flex flex-col gap-6 relative min-h-screen bg-white">
        ...
        <div className="no-print print:hidden flex justify-between items-center mb-4">
          <Button onClick={() => navigate(-1)} color="info" size="sm">
            {"<< Back"}
          </Button>
          ...
          <div className="relative z-10">
            ...
            <div className="grid grid-cols-2 gap-x-8 gap-y-4 mb-8 text-sm">
              ...
              <div className="flex">
                ...
                <span>{dinDetails.customer_address}<br />{dinDetails.gstno}</span>
              </div>
              ...
              <div className="flex">
                ...
                <span>{dinDetails.concern_designation}</span>
              </div>
              ...
              <div className="flex">
                ...
                <span>{dinDetails.purpose_name}</span>
              </div>
              <div className="flex">
