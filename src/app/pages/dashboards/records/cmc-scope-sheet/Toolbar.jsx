          ...
          <Menu as="div" className="relative inline-block text-left">
            ...
            >
              <MenuItem>
                {({ focus }) => (
                  <button
                    onClick={() => permissions.includes(86) && navigate("/dashboards/calibration-operations/cmc-scope-sheet/add-new-cmc-scope")}
                    className={clsx(
