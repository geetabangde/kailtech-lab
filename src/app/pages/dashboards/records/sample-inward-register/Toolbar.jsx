      ...
      >
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-4">
          <div>
            ...
            <DatePicker
              options={{ dateFormat: "Y-m-d", allowInput: true, maxDate: new Date() }}
              value={startDate}
          ...
          <div>
            ...
            <DatePicker
              options={{ dateFormat: "Y-m-d", allowInput: true, minDate: startDate || null, maxDate: new Date() }}
              value={endDate}
          ...
          <div>
            ...
            <Select
              ...
              value={customer ? { value: customer, label: customers.find((c) => String(c.id) === String(customer))?.name || "" } : null}
          ...
          <div>
            ...
            <Select
              ...
              value={department ? { value: department, label: departments.find((d) => String(d.id) === String(department))?.name || "" } : null}
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-4">
          <div>
            ...
            <Select
              ...
              value={product ? { value: product, label: products.find((p) => String(p.id) === String(product))?.name || "" } : null}
          ...
          <div className="flex gap-2 mt-6">
            ...
            <button
              ...
              onClick={() => {
                ...
                window.open(`/dashboards/records/sample-inward-register/export?${searchParams}`, "_blank");
              }}
              className="h-9 rounded bg-blue-600 px-4 text-sm font-medium text-white hover:bg-blue-700"
            >
              Export
