...
export default function PermissionsDatatable() {
  ...
  const [columnVisibility, setColumnVisibility] = useLocalStorage(
    "column-visibility-Permissions-index",
    {},
  );

  const [columnPinning, setColumnPinning] = useLocalStorage(
    "column-pinning-Permissions-index",
    {},
  );
  ...
  deleteRows: (rows) => {
    ...
    setPermissionsList((old) => old.filter((row) => !rowIds.includes(row.id)));
  },
  setTableSettings
},
    filterFns: {
  ...
  useDidUpdate(() => table.resetRowSelection(), [permissionsList]);
        ...
        >
          ...
          >
            ...
            >
              ...
              <SelectedRowsActions table={table} title="Permission List" showDelete={false} />
