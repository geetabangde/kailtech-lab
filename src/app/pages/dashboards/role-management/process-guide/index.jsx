...
export default function ProcessGuideDatatable() {
  ...
  deleteRows: (rows) => {
    ...
    setProcesses((old) => old.filter((row) => !rowIds.includes(row.id)));
  },
  setTableSettings
},
    filterFns: {
  ...
  useDidUpdate(() => table.resetRowSelection(), [processes]);
        ...
        >
          ...
          >
            ...
            >
              ...
              <SelectedRowsActions table={table} title="Processes List" showDelete={false} />
