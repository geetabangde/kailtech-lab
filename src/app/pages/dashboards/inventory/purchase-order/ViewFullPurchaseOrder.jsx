          ...
          <div className="mt-8 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-12 items-center gap-4 border-t pt-4 border-gray-100 dark:border-dark-600">
                  <label className="col-span-4 text-sm font-medium text-gray-600 dark:text-dark-200">
                    Contact Person
                  </label>
                  <div className="col-span-8">
                  ...
                  <tbody className="divide-y divide-gray-200 dark:divide-dark-500">
                    {purchaseOrderItems.map((item, index) => (
                      <tr key={item.id || index} className="hover:bg-gray-50 dark:hover:bg-dark-800/50">
                        ...
                        <td className="px-4 py-3 text-left text-gray-500 whitespace-pre-line">{item.specification || "—"}</td>
            ...
            <div className="flex justify-end pt-6">
              <div className="w-full max-w-md space-y-3 rounded-xl bg-gray-50 p-6 dark:bg-dark-800 border border-gray-150 dark:border-dark-600">
                ...
                <div className="flex justify-between text-sm font-semibold text-gray-700 dark:text-dark-100 border-b pb-2">
                ...
                <div className="flex justify-between text-sm text-gray-600 dark:text-dark-200 border-t pt-2">
                ...
                <div className="flex justify-between border-t border-gray-300 dark:border-dark-500 pt-3 text-lg font-bold text-gray-900 dark:text-dark-50">
                  <span>Total</span>
