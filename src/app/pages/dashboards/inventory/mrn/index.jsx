...
export default function MRNList() {
  ...
  const fetchMRN = async () => {
    try {
      setLoading(true);
      // Assuming endpoint based on pattern: inventory/mrn-list
      const response = await axios.get("inventory/mrn-chalan-list");
  ...
  const [columnVisibility, setColumnVisibility] = useLocalStorage(
    "column-visibility-mrn-list",
    {}
  );

  const [columnPinning, setColumnPinning] = useLocalStorage(
    "column-pinning-mrn-list",
    {}
  );
  ...
  return (
    <Page title="Material Receipt Note (MRN)">
