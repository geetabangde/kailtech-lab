...
// PHP permissions removed as they are unused here.
    ...
    <div className="table-toolbar">
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4">
          ...
          {/* Button - Hidden for Instrument Status as it is a report */}
          <div>
          </div>
        </div>
        ...
        {isXs ? (
          <Menu as="div" className="relative inline-block text-left">
            ...
            >
              {/* Menu items removed as they are not applicable to the report page */}
              <MenuItem>
                {({ focus }) => (
                  <button
                    className={clsx(
