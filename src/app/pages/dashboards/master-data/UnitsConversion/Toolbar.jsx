...
// PHP: if (in_array(80, $permissions)) for Add button
    ...
    <div className="table-toolbar">
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4">
          ...
          {/* Button */}
          <div>
            {/* PHP: <?php if (in_array(80, $permissions)) {?>
               <div class="box-tools pull-right"><a href="addunitconversion.php" class="btn btn-info">+ Add New Unit Conversion</a></div>
               <?php }?> */}
            {permissions.includes(80) && (
              <Link
                to="/dashboards/master-data/units-conversion/add-new-unit-conversion"
