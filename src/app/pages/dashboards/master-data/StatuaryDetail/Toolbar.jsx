        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4">
          ...
          <div>
            {/* PHP: <?php if (in_array(80, $permissions)) {?>
               <div class="box-tools pull-right"><a href="addstatuarydetail.php" class="btn btn-info">+ Add New Statuary Detail</a></div>
               <?php }?> */}
            {permissions.includes(80) && (
              <Link
                to="/dashboards/master-data/statuary-detail/add-new-statuary-detail"
