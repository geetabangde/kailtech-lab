...
export default function OrdersDatatableV1() {
  ...
  const [columnVisibility, setColumnVisibility] = useLocalStorage(
    "column-visibility-Currencies-index",
    {},
  );
  const [columnPinning, setColumnPinning] = useLocalStorage(
    "column-pinning-Currencies-index",
    {},
  );
  ...
  const fetchModes = async () => {
    try {
      ...
      const response = await axios.get("/master/currency-list");
        ...
        >
          ...
          >
            ...
            >
              ...
              <SelectedRowsActions table={table} title="Currencies List" showDelete={false} />
