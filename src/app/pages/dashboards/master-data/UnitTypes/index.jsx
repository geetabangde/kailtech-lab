...
// PHP: if(!in_array(87, $permissions)) header("location:index.php");
...
export default function OrdersDatatableV1() {
  ...
  const [columnVisibility, setColumnVisibility] = useLocalStorage(
    "column-visibility-UnitTypes-index",
    {},
  );

  const [columnPinning, setColumnPinning] = useLocalStorage(
    "column-pinning-UnitTypes-index",
    {},
  );
  ...
  if (!permissions.includes(87)) {
    return (
      <Page title="Unittype/ Parameter List">
        <div className="flex h-60 items-center justify-center rounded-xl border border-red-200 bg-red-50 dark:border-red-800 dark:bg-red-900/20">
          <p className="text-sm font-medium text-red-600 dark:text-red-400">
            Access Denied - Permission 87 required
          </p>
        </div>
      </Page>
    );
        ...
        >
          ...
          >
            ...
            >
              ...
              <SelectedRowsActions table={table} title="Unit Types List" showDelete={false} />
