...
// PHP: if(in_array(89, $permissions)) for Add button
    ...
    <div className="table-toolbar">
      <div className={clsx(
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4">
          ...
          {/* Button */}
          <div>
          {/* PHP: <?php if (in_array(89, $permissions)) {?>
             <div class="box-tools pull-right"><a href="addUnitTypes.php" class="btn btn-info">+ Add New Unittype/ Parameter</a></div>
             <?php }?> */}
          {permissions.includes(89) && (
            <Link
              to="/dashboards/master-data/unit-types/create"
