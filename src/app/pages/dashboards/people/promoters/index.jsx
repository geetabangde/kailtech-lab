...
export default function OrdersDatatableV1() {
 ...
 const [orders, setOrders] = useState([]);
  ...
  try {
    ...
    const response = await axios.get("/people/list-promoters");
  ...
  const [columnVisibility, setColumnVisibility] = useLocalStorage(
    "column-visibility-promoters-index",
    {},
  );

  const [columnPinning, setColumnPinning] = useLocalStorage(
    "column-pinning-promoters-index",
    {},
  );
        ...
        >
          ...
          >
            ...
            >
              ...
              <SelectedRowsActions table={table} title="Promoter List" showDelete={false} />
