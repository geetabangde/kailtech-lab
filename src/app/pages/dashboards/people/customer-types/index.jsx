...
export default function OrdersDatatableV1() {
  ...
  try {
    ...
    if (response.data.status && Array.isArray(response.data.Data)) {
      setOrders(response.data.Data); // ✅ capital 'D'
    } else {
  ...
  const [columnVisibility, setColumnVisibility] = useLocalStorage(
    "column-visibility-customer-types-index",
    {},
  );

  const [columnPinning, setColumnPinning] = useLocalStorage(
    "column-pinning-customer-types-index",
    {},
  );
        ...
        >
          ...
          >
            ...
            >
              ...
              <SelectedRowsActions table={table} title="Customer Types" showDelete={false} />
