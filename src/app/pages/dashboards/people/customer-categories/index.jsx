...
export default function OrdersDatatableV1() {
  ...
  const [columnVisibility, setColumnVisibility] = useLocalStorage(
    "column-visibility-customer-categories-index",
    {},
  );

  const [columnPinning, setColumnPinning] = useLocalStorage(
    "column-pinning-customer-categories-index",
    {},
  );
  ...
  return (
    <Page title="Customer Categories List">
        ...
        >
          ...
          >
            ...
            >
              ...
              <SelectedRowsActions table={table} title="Customer Categories" showDelete={false} />
