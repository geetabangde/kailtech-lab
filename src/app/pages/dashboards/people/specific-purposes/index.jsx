...
export default function OrdersDatatableV1() {
  ...
  const fetchModes = async () => {
    try {
      ...
      if (status === "true" && Array.isArray(data)) {
        ...
        console.warn("Unexpected response structure or data type:", response.data);
        setOrders([]);
      }
  ...
  const [columnVisibility, setColumnVisibility] = useLocalStorage(
    "column-visibility-specific-purposes-index",
    {},
  );

  const [columnPinning, setColumnPinning] = useLocalStorage(
    "column-pinning-specific-purposes-index",
    {},
  );
        ...
        >
          ...
          >
            ...
            >
              ...
              <SelectedRowsActions table={table} title="Specific Purposes" showDelete={false} />
