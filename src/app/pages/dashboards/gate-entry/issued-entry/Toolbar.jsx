        ...
        >
          <div className="flex shrink-0 space-x-2 ">
            ...
            <div className="flex items-center space-x-2">
              <span className="text-xs font-medium text-gray-500 dark:text-dark-200">Min Date:</span>
              <Input
                type="date"
                value={table.getState().dateFilter?.minDate || ""}
                onChange={(e) => table.options.meta.setDateFilter(prev => ({ ...prev, minDate: e.target.value }))}
                classNames={{
            ...
            <div className="flex items-center space-x-2">
              <span className="text-xs font-medium text-gray-500 dark:text-dark-200">Max Date:</span>
              <Input
                type="date"
                value={table.getState().dateFilter?.maxDate || ""}
                onChange={(e) => table.options.meta.setDateFilter(prev => ({ ...prev, maxDate: e.target.value }))}
                classNames={{
                  input: "h-8 text-xs ring-primary-500/50 focus:ring-3",
                  root: "w-32",
                }}
              ...
              <div className="w-32">
                <ReactSelect
                  ...
                  value={[
                    ...
                    { label: "Alloted", value: "1" },
                    { label: "Lrn Done", value: "2" },
                  ].find((p) => p.value === (table.getState().dateFilter?.status || "")) || { label: "All", value: "" }}
                  onChange={(selected) => table.options.meta.setDateFilter(prev => ({ ...prev, status: selected ? selected.value : "" }))}
