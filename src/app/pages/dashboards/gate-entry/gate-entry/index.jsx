...
// PHP: if(!in_array(289, $permissions)) header("location:index.php");
...
export default function OrdersDatatableV1() {
  ...
  }, [dateFilter.minDate, dateFilter.maxDate]);
  ...
  if (!permissions.includes(289)) {
    return (
      <Page title="Gate Entries">
        <div className="flex h-60 items-center justify-center rounded-xl border border-red-200 bg-red-50 dark:border-red-800 dark:bg-red-900/20">
          <p className="text-sm font-medium text-red-600 dark:text-red-400">
            Access Denied - Permission 289 required
          </p>
        </div>
      </Page>
    );
        ...
        >
          ...
          >
            ...
            >
              ...
              <SelectedRowsActions table={table} title="Gate entries" showDelete={false} />
