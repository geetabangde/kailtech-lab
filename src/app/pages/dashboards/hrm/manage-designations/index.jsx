...
export default function OrdersDatatableV1() {
  ...
  try {
    setLoading(true); 
    const response = await axios.get("/hrm/designation-list");
  ...
  const [columnVisibility, setColumnVisibility] = useLocalStorage(
    "column-visibility-manage-designations-index",
    {},
  );

  const [columnPinning, setColumnPinning] = useLocalStorage(
    "column-pinning-manage-designations-index",
    {},
  );
