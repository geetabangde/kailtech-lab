...
export default function EmployeeDatatableV1() {
  ...
  const [columnVisibility, setColumnVisibility] = useLocalStorage(
    "column-visibility-employees-1",
    {},
  );

  const [columnPinning, setColumnPinning] = useLocalStorage(
    "column-pinning-employees-1",
    {},
  );
  ...
  const table = useReactTable({
    ...
    meta: {
      ...
      deleteRows: (rows) => {
        ...
        setEmployees((old) => old.filter((row) => !rowIds.includes(row.id)));
      },
      setTableSettings
    },
    filterFns: {
