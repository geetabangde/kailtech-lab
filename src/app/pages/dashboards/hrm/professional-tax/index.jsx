...
export default function ProfessionalTaxDatatable() {
  ...
  const fetchTaxSlabs = async () => {
    try {
      ...
      console.error("Error fetching professional tax slabs:", err);
    } finally {
      setLoading(false);
    }
  };
  ...
  const [columnVisibility, setColumnVisibility] = useLocalStorage(
    "column-visibility-professional-tax",
    {},
  );
  const [columnPinning, setColumnPinning] = useLocalStorage(
    "column-pinning-professional-tax",
    {},
  );
  ...
  const table = useReactTable({
    ...
    meta: {
      ...
      deleteRows: (rows) => {
        ...
        setTaxSlabs((old) => old.filter((row) => !rowIds.includes(row.id)));
      },
      setTableSettings,
    },
    filterFns: {
