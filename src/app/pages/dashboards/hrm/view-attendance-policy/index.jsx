...
export default function AttendancePolicyDatatable() {
  ...
  const fetchPolicies = async () => {
    try {
      setLoading(true);
      const response = await axios.get("/hrm/attendance-policy-list");
  ...
  const [columnVisibility, setColumnVisibility] = useLocalStorage(
    "column-visibility-attendance-policy",
    {},
  );
  const [columnPinning, setColumnPinning] = useLocalStorage(
    "column-pinning-attendance-policy",
    {},
  );
