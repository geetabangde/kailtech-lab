...
export default function OrdersDatatableV1() {
  ...
  try {
    setLoading(true); 
    const response = await axios.get("/hrm/salary-structure-list");
  ...
  const [columnVisibility, setColumnVisibility] = useLocalStorage(
    "column-visibility-salary-structure-design-index",
    {},
  );

  const [columnPinning, setColumnPinning] = useLocalStorage(
    "column-pinning-salary-structure-design-index",
    {},
  );
    ...
    return (
      <Page title="Modes List">
        <div className="flex h-[60vh] items-center justify-center text-gray-600">
          ...
          Loading salary structure design...
        </div>
      </Page>
    );
  }
