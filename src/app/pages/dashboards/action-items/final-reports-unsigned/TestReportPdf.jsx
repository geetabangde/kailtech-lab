...
const SS = StyleSheet.create({
  ...
  infoRight: { flex: 1 },
  infoLabel: { width: "52%", padding: 3, fontFamily: "Helvetica-Bold", borderRightWidth: 0.5, borderRightColor: BC, fontSize: 8.5 },
  infoVal: { flex: 1, padding: 3, fontSize: 8.5 },
  infoFull: { padding: 4, borderTopWidth: 0.5, borderTopColor: BC, fontSize: 8.5 },
  ...
  thSno: { width: "5%", padding: 3, fontFamily: "Helvetica-Bold", textAlign: "center", fontSize: 8.5, borderRightWidth: 0.5, borderRightColor: BC },
  thParam: { width: "30%", padding: 3, fontFamily: "Helvetica-Bold", fontSize: 8.5, borderRightWidth: 0.5, borderRightColor: BC },
  thUnit: { width: "8%", padding: 3, fontFamily: "Helvetica-Bold", textAlign: "center", fontSize: 8.5, borderRightWidth: 0.5, borderRightColor: BC },
  thResult: { width: "14%", padding: 3, fontFamily: "Helvetica-Bold", textAlign: "center", fontSize: 8.5, borderRightWidth: 0.5, borderRightColor: BC },
  thMethod: { width: "25%", padding: 3, fontFamily: "Helvetica-Bold", textAlign: "center", fontSize: 8.5, borderRightWidth: 0.5, borderRightColor: BC },
  thSpec: { width: "18%", padding: 3, fontFamily: "Helvetica-Bold", textAlign: "center", fontSize: 8.5 },
  tdSno: { width: "5%", padding: 3, textAlign: "center", fontSize: 8.5, borderRightWidth: 0.5, borderRightColor: BC },
  tdParam: { width: "30%", padding: 3, fontSize: 8.5, borderRightWidth: 0.5, borderRightColor: BC },
  tdUnit: { width: "8%", padding: 3, textAlign: "center", fontSize: 8.5, borderRightWidth: 0.5, borderRightColor: BC },
  tdResult: { width: "14%", padding: 3, textAlign: "center", fontSize: 8.5, borderRightWidth: 0.5, borderRightColor: BC },
  tdMethod: { width: "25%", padding: 3, textAlign: "center", fontSize: 8.5, borderRightWidth: 0.5, borderRightColor: BC },
  tdSpec: { width: "18%", padding: 3, textAlign: "center", fontSize: 8.5 },

  // Results table — landscape (wider cols)
  lsThSno: { width: "4%", padding: 3, fontFamily: "Helvetica-Bold", textAlign: "center", fontSize: 8, borderRightWidth: 0.5, borderRightColor: BC },
  lsThParam: { width: "28%", padding: 3, fontFamily: "Helvetica-Bold", fontSize: 8, borderRightWidth: 0.5, borderRightColor: BC },
  lsThUnit: { width: "8%", padding: 3, fontFamily: "Helvetica-Bold", textAlign: "center", fontSize: 8, borderRightWidth: 0.5, borderRightColor: BC },
  lsThResult: { width: "12%", padding: 3, fontFamily: "Helvetica-Bold", textAlign: "center", fontSize: 8, borderRightWidth: 0.5, borderRightColor: BC },
  lsThMethod: { width: "28%", padding: 3, fontFamily: "Helvetica-Bold", textAlign: "center", fontSize: 8, borderRightWidth: 0.5, borderRightColor: BC },
  lsThSpec: { width: "20%", padding: 3, fontFamily: "Helvetica-Bold", textAlign: "center", fontSize: 8 },
  lsTdSno: { width: "4%", padding: 3, textAlign: "center", fontSize: 8, borderRightWidth: 0.5, borderRightColor: BC },
  lsTdParam: { width: "28%", padding: 3, fontSize: 8, borderRightWidth: 0.5, borderRightColor: BC },
  lsTdUnit: { width: "8%", padding: 3, textAlign: "center", fontSize: 8, borderRightWidth: 0.5, borderRightColor: BC },
  lsTdResult: { width: "12%", padding: 3, textAlign: "center", fontSize: 8, borderRightWidth: 0.5, borderRightColor: BC },
  lsTdMethod: { width: "28%", padding: 3, textAlign: "center", fontSize: 8, borderRightWidth: 0.5, borderRightColor: BC },
  lsTdSpec: { width: "20%", padding: 3, textAlign: "center", fontSize: 8 },

  secTitle: { fontFamily: "Helvetica-Bold", fontSize: 10, marginBottom: 3, marginTop: 4 },
  endOfReport: { textAlign: "center", fontFamily: "Helvetica-Bold", marginVertical: 10, fontSize: 9 },
  remarkBox: { marginBottom: 6, fontSize: 8.5 },

  // Signatories
  sigRow: { flexDirection: "row", flexWrap: "wrap", marginTop: 22, marginBottom: 8 },
  sigBox: { minWidth: 150, marginRight: 20, fontSize: 8.5 },
  sigImg: { width: 100, height: 38, objectFit: "contain", marginBottom: 2 },
  sigDig: { width: 130, height: 52, objectFit: "contain" },
  sigElec: { fontSize: 8, color: "#444", marginTop: 1 },
  sigTit: { fontSize: 8, color: "#555", marginBottom: 2 },
  sigName: { fontFamily: "Helvetica-Bold", fontSize: 8.5 },
  sigAuth: { fontSize: 8, color: "#666" },
