    ...
    <AccordionItem value={path} className="relative flex flex-1 flex-col px-3">
      {({ open }) => (
        <>
          <AccordionButton
            className={clsx(
              "group cursor-pointer flex flex-1 items-center justify-between rounded-lg px-3 py-2 font-medium outline-none transition-colors duration-300 ease-in-out",
              open
